...
var REGISTRY = exports.REGISTRY = '0xc1b66dea11f8f321b7981e1666fdaf3637fe0f61';
...
function attributeToHex(key, value) {
  ...
  var match = key.match(/^did\/(publicKey|authentication)\/\w+\/\w+(Base64)$/);
  if (match) {
...
var EthrDID = function () {
  ...
  (0, _createClass3.default)(EthrDID, [{
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                return _context5.abrupt('return', this.registry.setAttribute(this.address, key, attributeToHex(key, value), expiresIn, { from: owner }));
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                return _context6.abrupt('return', kp);
    ...
    key: 'signJWT',
    value: function () {
      var _ref7 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(payload, expiresIn) {
        var options;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                return _context7.abrupt('return', (0, _didJwt.createJWT)(payload, options));
    ...
    key: 'verifyJWT',
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(jwt) {
        var audience = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.did;
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                return _context8.abrupt('return', (0, _didJwt.verifyJWT)(jwt, { audience: audience }));
